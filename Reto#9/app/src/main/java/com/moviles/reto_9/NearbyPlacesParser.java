...
public class NearbyPlacesParser {
    ...
    public static final String JSON_KEY_ID = "place_id";
    ...
    public List<NearbyPlace> listNearbyPlace(String nearbyPlacesURLString) {
        ...
        do {
            try {
                ...
                nearbyPlacesURLString = MainActivity.URL_PREFIX.concat(MainActivity.PARAMETER_PAGETOKEN).concat(pageToken);
